    ...
    <Fragment>
      <div>
        ...
        <div className="b-nav">
          ...
          <li >
            <NavLink exact activeClassName="active" className="b-link nav-link" to="/inventario" onClick={clickHandle} data-toggle="tooltip" data-placement="right" title="Es un algoritmo que nos permite buscar la forma optima del cambio de equipos que estan sujetos a falla, perdida de eficienta o desgaste.">Reemplazo de Equipos</NavLink>
          </li>
          <li >
          ...
          <li>
            <NavLink exact activeClassName="active" className="b-link nav-link" to="/venta" onClick={clickHandle} data-toggle="tooltip" data-placement="right" title="Algoritmo que determina la máxima probabilidad de gane ante 2 equipos.">Series Deportivas</NavLink>
          </li>
          <li>
